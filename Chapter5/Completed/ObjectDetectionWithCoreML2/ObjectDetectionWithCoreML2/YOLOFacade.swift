...
class YOLOFacade{
    ...
    func asyncDetectObjects(photos:[UIImage], completionHandler: @escaping (_ result:[[ObjectBounds]]?) -> Void){
        DispatchQueue.global(qos: .background).sync {
            
            self.detectObjects(photos: photos, completionHandler: { (result) -> Void in
